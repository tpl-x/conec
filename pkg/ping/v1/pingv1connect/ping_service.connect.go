...
var (
	pingServiceServiceDescriptor    = v1.File_ping_v1_ping_service_proto.Services().ByName("PingService")
...
type PingServiceClient interface {
	// simple ping rpc
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PongResponse], error)
}
...
func NewPingServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PingServiceClient {
	...
	return &pingServiceClient{
		ping: connect.NewClient[v1.PingRequest, v1.PongResponse](
			httpClient,
...
type pingServiceClient struct {
	ping *connect.Client[v1.PingRequest, v1.PongResponse]
}

// Ping calls ping.v1.PingService.Ping.
func (c *pingServiceClient) Ping(ctx context.Context, req *connect.Request[v1.PingRequest]) (*connect.Response[v1.PongResponse], error) {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PongResponse], error) {
